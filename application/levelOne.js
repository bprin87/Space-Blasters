class LevelTwo extends Phaser.Scene {
    ...
    create() {
        ...
        // add game won text and set to hidden
        this.gameWonText = this.add.text(this.cameras.main.width / 2, this.cameras.main.height / 2, 'YOU WIN!', { font: '80px Orbitron', stroke: 'black', strokeThickness: 2 }).setOrigin(0.5);
    ...
    update() {
        ...
        if (this.score >= 'enemy-ship'.length + 2) {
            ...
            this.gameWonText.setScrollFactor(0);
        }
    }
